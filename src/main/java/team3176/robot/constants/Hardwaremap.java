...
public class Hardwaremap {
  ...
  public static final int shooterWheelPort_CID = 6;
  public static final int shooterWheelStarbrd_CID = 7;
  public static final int shooterPivot_CID = 8;
  public static final int intakeRoller_CID = 9;
  public static final int intakePivot_CID = 16;
  public static final int armEncoder_CID = 17;
