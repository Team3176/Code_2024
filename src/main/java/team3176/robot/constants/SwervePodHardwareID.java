...
public class SwervePodHardwareID {
  ...
  SwervePodHardwareID(int thrust_cid, String thrust_cbn, int cancoder_cid, String cancoder_cbn, double offset) {
  ...
  SwervePodHardwareID(int serial, int thrust_cid, String thrust_cbn, int cancoder_cid, String cancoder_cbn, double offset) {
    this.THRUST_CID = thrust_cid;
    this.THRUST_CBN = thrust_cbn;
    this.CANCODER_CID = cancoder_cid;
    this.CANCODER_CBN = cancoder_cbn;
