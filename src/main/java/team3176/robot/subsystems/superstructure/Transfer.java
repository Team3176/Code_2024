...
public class Transfer extends SubsystemBase {
    ...
    private Transfer(TransferIO io) {
        this.io = io;
        this.turningPIDController = new PIDController(SuperStructureConstants.TRANSFER_kP, SuperStructureConstants.TRANSFER_kI, SuperStructureConstants.TRANSFER_kD);
...
*/
    ...
    public void periodic() {
        ...
        armSholder.setAngle(Rotation2d.fromDegrees(inputs.Position-SuperStructureConstants.TRANSFER_ZERO_POS-190));
        ...
        Pose3d elbow = shoulder_offset.transformBy(
            new Transform3d(
                ...
                new Rotation3d(0.0, Units.degreesToRadians(-((50 + 120 * (SuperStructureConstants.TRANSFER_CARRY_POS - (inputs.Position))/(SuperStructureConstants.TRANSFER_CARRY_POS-SuperStructureConstants.TRANSFER_ZERO_POS))) + 130 + 240 ), 0.0)));
        ...
        if(this.currentState == States.CLOSED_LOOP) {
            this.armSetpointAngleRaw = MathUtil.clamp(this.armSetpointAngleRaw, SuperStructureConstants.TRANSFER_ZERO_POS, SuperStructureConstants.TRANSFER_PICKUP_POS);
