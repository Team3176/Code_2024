...
public class ElevatorIOFalcon implements ElevatorIO{
  ...
  public ElevatorIOFalcon() {
    ...
    elevatorLeaderMotor = new TalonFX(Hardwaremap.elevatorLeaderMotor_CID, Hardwaremap.elevatorLeaderMotor_CBN);
    elevatorFollowerMotor = new TalonFX(Hardwaremap.elevatorFollowerMotor_CID, Hardwaremap.elevatorFollowerMotor_CBN);
    //config setting
