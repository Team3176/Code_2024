...
public class ShooterIOTalonSparkInternal implements ShooterIO {
  ...
  */
  ...
  private SparkPIDController pivotPIDController = pivotShooter.getPIDController();
  ...
  public ShooterIOTalonSparkInternal() {
    ...
    pivotPIDController.setP(SuperStructureConstants.SHOOTER_PIVOT_kP);
    pivotPIDController.setI(SuperStructureConstants.SHOOTER_PIVOT_kI);
    pivotPIDController.setD(SuperStructureConstants.SHOOTER_PIVOT_kD);
    pivotPIDController.setOutputRange(
        SuperStructureConstants.SHOOTER_PIVOT_MIN_OUTPUT,
        SuperStructureConstants.SHOOTER_PIVOT_MAX_OUTPUT);
    pivotEncoder.setPosition(0.0);
    pivotEncoder.setPositionConversionFactor(30.0);
