...
public class PhotonVisionSystem extends SubsystemBase {
  ...
  public static final Transform3d camera2Robot =
      new Transform3d(
          new Translation3d(Units.inchesToMeters(19), 0, camHeightOffGround),
  ...
  public void periodic() {
    ...
    if (results.hasTargets()) {
      ...
      Logger.recordOutput(
          "photonvision/poseEstimates", estimates.toArray(new Pose3d[estimates.size()]));
    } else {
